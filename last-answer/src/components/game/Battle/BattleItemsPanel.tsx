...
export function BattleItemsPanel({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={[
        "group relative flex h-[5rem] w-[5.4rem] shrink-0 appearance-none items-center justify-center overflow-hidden border-0 bg-transparent p-0 text-center text-[0.9rem] font-semibold tracking-[0.02em] text-[#ead3b1] shadow-[0_10px_20px_rgba(0,0,0,0.42)] outline-none transition duration-200 sm:h-[5.4rem] sm:w-[5.8rem]",
        disabled
