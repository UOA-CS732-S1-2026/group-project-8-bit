  ...
  return (
    <div
      className={[
        ...
        .filter(Boolean)
        .join(" ")}
      style={{ width: "min(21.5rem, calc(100% - 0.5rem))" }}
    >
      <section
        className={[
      ...
      >
        <div className="relative flex items-center gap-2 px-2.5 py-2.5 sm:gap-2.5 sm:px-3 sm:py-3">
          ...
          <div
            className={[
              "w-[2.75rem] shrink-0 text-right sm:w-[3rem]",
              isWarning ? "animate-pulse" : "",
            ]
              .filter(Boolean)
              .join(" ")}
          >
            <div className="text-[0.96rem] font-semibold leading-none text-[#ecd7b7] sm:text-[1.08rem]">
              {roundedSeconds}s
            </div>
          </div>
        </div>
