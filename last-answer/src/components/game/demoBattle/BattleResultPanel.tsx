...
export function BattleResultPanel({
  ...
  if (status === "won" && reward) {
    return (
      <div className="mt-1 rounded-2xl border border-emerald-300/25 bg-emerald-400/10 p-1">
        ...
        <div className="mt-1 grid gap-1 sm:grid-cols-2">
          <div className="rounded-2xl bg-black/25 p-1">
        ...
        <div className="mt-1 grid gap-1 text-sm text-stone-300 sm:grid-cols-2">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-1 rounded-full border border-emerald-200/35 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-100 transition hover:bg-emerald-200/10"
        >
          Back to Hub
        </button>
      </div>
  ...
  return (
    <div className="mt-1 rounded-2xl border border-rose-300/25 bg-rose-400/10 p-1">
      ...
      <button
        type="button"
        onClick={onClose}
        className="mt-1 rounded-full border border-rose-200/35 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-rose-100 transition hover:bg-rose-200/10"
      >
        Back to Hub
      </button>
    </div>
